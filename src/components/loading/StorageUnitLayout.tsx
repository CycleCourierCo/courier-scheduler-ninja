  ...
  return (
    <div className="w-full overflow-x-auto">
      <div className="min-w-[320px] space-y-3">
        {bays.map((bay) => {
          ...
          return (
            <div key={bay.id} className="flex items-center gap-2 sm:gap-4">
              <div className="w-12 sm:w-16 text-center font-bold text-small sm:text-body-lg text-primary flex-shrink-0">
                ...
                <div className="flex gap-0.5 sm:gap-1 flex-wrap">
                  {positions.map((position) => {
                    ...
                    const bayContent = (
                      <div
                        className={cn(
                          "w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center text-caption font-medium rounded border-2 transition-colors cursor-pointer",
                          occupied
                            ? "bg-red-500 text-white border-red-600"
                            : "bg-green-100 border-green-300 text-green-800 hover:bg-green-200"
                        )}
                      >
                        <span className="text-caption sm:text-caption">{position}</span>
                      </div>
                    );
                          ...
                          <HoverCardContent className="w-80">
                            <div className="space-y-3">
                              <div className="flex items-center justify-between">
                                ...
                                <Badge variant="outline" className="text-caption">Occupied</Badge>
                              </div>
        ...
        <div className="flex gap-4 justify-center text-small">
          <div className="flex items-center gap-2">
