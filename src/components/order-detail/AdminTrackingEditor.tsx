    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <h3 className="font-semibold text-body-lg">Tracking Events (JSON)</h3>
        </div>
        {!isEditing ? (
          <Button
            variant="outline"
      ...
      <div className="bg-gray-50 p-4 rounded-md">
        {isEditing ? (
          <div>
            <Label htmlFor="tracking-json" className="text-small mb-2 block">
            ...
            <Textarea
              ...
              className="font-mono text-small min-h-[300px]"
          ...
          <pre className="font-mono text-small overflow-x-auto whitespace-pre-wrap">
            {trackingJson}
          </pre>
        )}
      </div>
