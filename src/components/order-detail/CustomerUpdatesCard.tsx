...
const STAGE_LABELS: Record<string, string> = {
  ...
  in_depot_awaiting_inspection: "At depot, awaiting inspection",
  in_depot_inspected: "Inspected, no issues",
  in_depot_issues_found: "Issues found",
  in_depot_in_repair: "Repairs underway",
  in_depot_service_complete: "Service complete",
  sender_bike_on_way: "Seller: bike on its way to buyer",
