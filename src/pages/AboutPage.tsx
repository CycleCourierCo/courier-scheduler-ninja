...
const AboutPage: React.FC = () => {
  return <Layout>
      <div className="max-w-4xl mx-auto">
        <Card>
          <CardHeader>
            <CardTitle className="text-h2 font-bold text-center">About The Cycle Courier Co.</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <p className="text-h4 font-semibold text-courier-500 text-center">
            ...
            <p className="text-body-lg">With our specialist inspection service, we go the extra mile to ensure that bikes arrive in perfect condition. Every bike we transport is fully insured to its value, so you can rest assured that your pride and joy is in safe hands.</p>
            ...
            <h2 className="text-h3 font-semibold mt-6">Contact Us</h2>
            <p>
