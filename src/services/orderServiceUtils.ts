...
export const mapDbOrderToOrderType = (dbOrder: any): Order => {
  ...
  const result: Order = {
    ...
    boxBuyerCollectedEmailSentAt: dbOrder.box_buyer_collected_email_sent_at || null,
    ...
    niInboundCollectedAt: dbOrder.ni_inbound_collected_at ? parseDate(dbOrder.ni_inbound_collected_at) : null,
    niInboundFerryCrossedAt: dbOrder.ni_inbound_ferry_crossed_at ? parseDate(dbOrder.ni_inbound_ferry_crossed_at) : null,
    niInboundReceivedAt: dbOrder.ni_inbound_received_at ? parseDate(dbOrder.ni_inbound_received_at) : null,
