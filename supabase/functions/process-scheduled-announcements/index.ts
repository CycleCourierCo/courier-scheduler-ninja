...
<tr><td style="background:${BRAND.primary};padding:20px 32px;" align="left"><img src="https://booking.cyclecourierco.com/cycle-courier-logo.png" alt="${BRAND.name}" height="56" style="height:56px;width:auto;display:block;border:0;outline:none;background:#ffffff;border-radius:6px;padding:6px;"></td></tr>
...
<tr><td style="background:#F2F5F7;padding:20px 32px;font-size:11px;line-height:1.5;color:${BRAND.muted};text-align:center;">
