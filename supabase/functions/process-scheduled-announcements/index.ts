...
<tr><td style="background:linear-gradient(135deg,${BRAND.primary},${BRAND.primaryDark});padding:20px 32px;" align="left"><img src="https://booking.cyclecourierco.com/cycle-courier-logo.png" alt="${BRAND.name}" height="56" style="height:56px;width:auto;display:block;border:0;outline:none;background:#ffffff;border-radius:6px;padding:6px;"></td></tr>
