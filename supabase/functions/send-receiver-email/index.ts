...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`Sending receiver email to ${to} for order ${orderId}`);
    ...
    const data = await resend.emails.send({
      ...
      to: [to],
      subject: "Confirm Your Availability for Delivery - Cycle Courier Co",
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h1 style="color: #374151;">Please Confirm Your Availability for Delivery</h1>
          <p>Hello ${name},</p>
          <p>A package is ready to be delivered to you through Cycle Courier Co. To schedule the delivery, please confirm your availability by clicking the button below:</p>
    ...
    console.log("Email sent successfully to receiver:", data);
