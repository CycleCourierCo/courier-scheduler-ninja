...
-- Function to map order status to webhook event type
...
-- Function to trigger webhook on order status change
...
-- Create the trigger
DROP TRIGGER IF EXISTS order_status_change_webhook ON orders;
CREATE TRIGGER order_status_change_webhook
