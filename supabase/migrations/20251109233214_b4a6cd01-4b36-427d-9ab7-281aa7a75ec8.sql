-- Update admin_generate_webhook_secret to store plaintext secret in Vault
CREATE OR REPLACE FUNCTION public.admin_generate_webhook_secret(p_user_id uuid, p_name text, p_endpoint_url text, p_events text[])
