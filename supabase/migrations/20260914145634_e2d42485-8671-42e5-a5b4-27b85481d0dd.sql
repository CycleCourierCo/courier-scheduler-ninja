...
BEGIN
  ...
  INSERT INTO public.profiles (
    ...
    account_status, address_line_1, address_line_2, city, county, postal_code, country,
  ...
  VALUES (
    ...
    NULLIF(btrim(coalesce(new.raw_user_meta_data->>'county', '')), ''),
    new.raw_user_meta_data->>'postal_code',
    coalesce(NULLIF(btrim(coalesce(new.raw_user_meta_data->>'country', '')), ''), 'United Kingdom'),
    v_accounts_email,
    v_opening_hours
  );
